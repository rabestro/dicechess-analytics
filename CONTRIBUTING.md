...
See [AGENTS.md](AGENTS.md) for branch naming, issue conventions, labels, and quality
gates, and the [project documentation](docs/) for architecture and domain conventions.
